    ...
    return (
        <section className="section pt-0 mt-0 pr-0 mr-0 pl-0 pr-0">
            <div className="container is-fullhd">
                ...
                class="has-ratio"
                alt="" 
                width="2000" height="360" src="/assets/car.jpg" frameborder="0" allowfullscreen></Image>
                </figure>
            </div> 
            <div className="content is-size-5 pr-5 mr-5 pl-5 ml-5 mt-5 pt-5">
                ...
                <p class="title is-size-4">1. Advancing Technology and Connectivity:</p>
                <div className="content">
                    <p>
                ...
                <p class="title is-size-4">2. Environmental Benefits:</p>
                <div className="content">
                    <p>
                ...
                <p class="title is-size-4">3. Infrastructure and Charging Networks:</p>
                <div className="content">
                    <p>
                ...
                <p class="title is-size-4">4. Shaping a Sustainable Future:</p>
                <div className="content">
                    <p>
